...
--
-- Host: localhost
-- Generation Time: Sep 13, 2022 at 12:22 PM
...
--
-- Database: `Detecting_Phishing_Effectively`
--
CREATE DATABASE IF NOT EXISTS `Detecting_Phishing_Effectively` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `Detecting_Phishing_Effectively`;
...
('0g2g8w1wt34rendf9gyo2d5k5d3ekqxa', 'eyJ1c2VyaWQiOjJ9:1oSeHQ:iqFHNRZrs4Of1yHrmDqVx8G0qbzgi4xt-l0CJzDCMbA', '2022-09-12 12:54:16.849604'),
...
('79wfp5me3gwac3x1z294g79a7ru8qkml', 'eyJ1c2VyaWQiOjF9:1oScT9:2e6tK4964ZC027qtDNYQ87Ms68cO_3P-FS1qfEg_Rkg', '2022-09-12 10:58:15.892045'),
...
('zdhg8pul03yzu1u4sj0grpnzbzllvwkr', 'eyJ1c2VyaWQiOjF9:1oY3pm:uuAZTky0ucjQZHpddDVOheoQb7ou4FU-5crmgtcXz7c', '2022-09-27 11:12:06.658919'),
...
('zmofgu2d0nsdkrtwfope4feeyde33r0c', 'eyJ1c2VyaWQiOjJ9:1oY4rU:dg4WW43SngqbbK_7hsp5d5ByqprATSlUIYjy5PTgTGE', '2022-09-27 12:17:56.867264');
...
(1, 'Rajesh', 'Rajesh123@gmail.com', 'Rajesh', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,11th main,Rajajinagar', 'Male'),
(2, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#892,4th Cross,Malleshwaram', 'Male');
...
(16, 'Naive Bayes', '97.3021582733813'),
(17, 'SVM', '98.11151079136691'),
(18, 'Logistic Regression', '98.02158273381295'),
(19, 'Decision Tree Classifier', '96.13309352517986'),
(20, 'Gradient Boosting Classifier', '90.1978417266187'),
(21, 'KNeighborsClassifier', '92.62589928057554');
...
--
-- Table structure for table `remote_user_spam_detection`
--

CREATE TABLE IF NOT EXISTS `remote_user_spam_detection` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `remote_user_spam_detection`
--

INSERT INTO `remote_user_spam_detection` (`id`, `Message`, `Prediction`) VALUES
(1, 'Aiya we discuss later lar... Pick u up at 4 is it?', 'Ham'),
(2, 'U can WIN Â£100 of Music Gift Vouchers every week starting NOW Txt the word DRAW to 87066 TsCs www.ldew.com SkillGame,1Winaweek, age16.150ppermessSubscription', 'Spam'),
(3, '1Apple/Day=No Doctor. 1Tulsi Leaf/Day=No Cancer. 1Lemon/Day=No Fat. 1Cup Milk/day=No Bone Problms 3 Litres Watr/Day=No Diseases Snd ths 2 Whom U Care..:-)', 'Ham'),
(4, 'Yeah you should. I think you can use your gt atm now to register. Not sure but if there''s anyway i can help let me know. But when you do be sure you are ready.', 'Ham'),
(5, 'Congratulations ur awarded 500 of CD vouchers or 125gift guaranteed & Free entry 2 100 wkly draw txt MUSIC to 87066 TnCs www.Ldew.com1win150ppmx3age16\r\n', 'Spam'),
(6, 'Urgent! call 09066612661 from landline. Your complementary 4* Tenerife Holiday or Â£10,000 cash await collection SAE T&Cs PO Box 3 WA14 2PX 150ppm 18+ Sender: Hol Offer\r\n', 'Spam');
