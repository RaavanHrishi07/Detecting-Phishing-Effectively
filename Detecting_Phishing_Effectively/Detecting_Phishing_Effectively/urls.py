"""a_robust_approach_for_effective_spam_detection URL Configuration
...
from Detecting_Phishing_Effectively import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Message_Type/$', remoteuser.Predict_Message_Type, name="Predict_Message_Type"),
    ...
    url(r'^View_Message_Type_Ratio/$', serviceprovider.View_Message_Type_Ratio, name="View_Message_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Message_Type/$', serviceprovider.View_Prediction_Of_Message_Type, name="View_Prediction_Of_Message_Type"),
