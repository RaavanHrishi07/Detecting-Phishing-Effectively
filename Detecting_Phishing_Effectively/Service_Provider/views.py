...
def View_Message_Type_Ratio(request):
    detection_ratio.objects.all().delete()
    ratio = ""
    kword = 'Ham'
    print(kword)
    obj = spam_detection.objects.all().filter(Q(Prediction=kword))
    obj1 = spam_detection.objects.all()
    count = obj.count();
    count1 = obj1.count();
    ...
    kword12 = 'Spam'
    print(kword12)
    obj12 = spam_detection.objects.all().filter(Q(Prediction=kword12))
    obj112 = spam_detection.objects.all()
    count12 = obj12.count();
    ...
    return render(request, 'SProvider/View_Message_Type_Ratio.html', {'objs': obj})
...
def View_Prediction_Of_Message_Type(request):
    obj =spam_detection.objects.all()
    return render(request, 'SProvider/View_Prediction_Of_Message_Type.html', {'list_objects': obj})
...
def Download_Predicted_DataSets(request):
    ...
    for my_row in data:
        row_num = row_num + 1
        ws.write(row_num, 0, my_row.Message, font_style)
